    ...
    <tbody>
        <tr>
            <td class="main-table-td">
                ...
                <h2>Campaign Join Request</h2>
                <div class="mb-1">Hi Admin,</div>
                <div class="mb-2"><a href="" class="text-base">Morning Mart</a> has requested to Join the <span class="text-base">Weekly Dhamaka</span> Campaign</div>
                <div class="mb-4">Review their request from admin panel.</div>
                <img class="mb-2" src="{{asset('/public/assets/admin/img/campaign-req.png')}}" alt="">
