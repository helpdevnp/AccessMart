    ...
    <tbody>
        <tr>
            <td class="main-table-td">
                ...
                <img src="{{asset('/public/assets/admin/img/withdraw-req.png')}}" alt="">
                    <h2>New Withdraw Request</h2>
                    <div class="mb-2">Transaction ID - 23984357sd834</div>
                    <div class="mb-4"><a href="" class="text-base">Morning Mart</a> has requested to withdraw money from their Balance</div>
                    <div class="mb-4"><a href="" class="text-base">Note:</a> Please review this withdraw request.</div>
                </div>
                ...
                <span class="d-block text-center" style="margin-top: 16px">
                    <a href="" class="cmn-btn">View Withdraw Request</a>
                </span>
                <hr>
                <div class="mb-2">
