    ...
    <tbody>
        <tr>
            <td class="main-table-td">
                ...
                <h2>New Store Registration Request</h2>
                <div class="mb-1">Hi Admin,</div>
                <div class="mb-4"><strong>Morning Mart</strong> has requested to open their store in 6amMart. </div>
                <div class="mb-2">Review their request from admin panel.</div>
                <img class="mb-2" src="{{asset('/public/assets/admin/img/store-reg.png')}}" alt="">
