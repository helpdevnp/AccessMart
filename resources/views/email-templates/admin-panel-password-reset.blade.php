        ...
        <tr>
            <td style="padding:0 30px 30px; text-align:left">
                ...
                <span style="display:block;margin-bottom:14px">
                    {{ translate('Please_click') }} <a href="{{ $url }}" style="font-weight:500;color:#0177CD">{{ translate('here
                    ') }}</a>  {{ translate('or_click_the_link_below_to_change_your_password') }}
                </span>
                <span style="display:block;margin-bottom:14px">
                ...
                <span class="d-block" style="margin-bottom:14px">{{ translate('Please_contact_us_for_any_queries_,_we’re_always_happy_to_help.') }} </span>
                <span class="d-block">{{ translate('Thanks_&_Regards_,') }}</span>
