    ...
    <table style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
        <tr>
            <td style="padding:30px 30px 0">
                <img src="{{asset('/public/assets/admin/img/admin-reg.png')}}" alt="">
                <h3 style="font-size:17px;font-weight:500">Registration Approved !</h3>
        ...
        <tr>
            <td style="padding:0 30px 30px; text-align:left">
                ...
                <span style="display:block;margin-bottom:14px">
                    Your registration request has been approved by admin. Now you can setup products & other information of your store from your panel
                </span>
                <span style="display:block;margin-bottom:14px">
                    <span style="display:block">Click here to visit your store</span>
                    <a href="" style="color: #0177CD">https://6ammart/store/login</a>
                </span>
