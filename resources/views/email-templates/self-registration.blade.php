  ...
  <div style="width:595px;margin:auto; background-color:white;
      ...
      <div class="congrats-box">
          ...
          @elseif ($status=='denied')
              <span style="font-weight: 700;font-size: 26px;color: #000000;text-transform: uppercase; line-height: 135.5%; display:block; margin-bottom:5px;">{{translate('messages.sorry')}}</span>
          @endif
          <span style="font-weight: 700;font-size: 14px;line-height: 135.5%;text-align: center;color: #727272; display:block;">{{translate($status=='approved'?'messages.Registration request approved':($status=='denied'?'messages.Registration request denied':'messages.Registration request successfull'))}}</span>
      </div>
      ...
      <span style="font-weight: 400;font-size: 14px;line-height: 135.5%;color: #182E4B;display:block; margin-bottom:34px;">{{translate($status=='approved'?'messages.Thank you for joinning with':'messages.Thank you for the joinning request on')}} <span style="color: #EF7822;">{{$company_name}}!</span></span>
      <span style="font-weight: 400;font-size: 12px;line-height: 135.5%;color: #5D6774; display:block; margin-bottom:82px;">{{translate('messages.Your registration request is now pending')}} @if ($status=='pending')
