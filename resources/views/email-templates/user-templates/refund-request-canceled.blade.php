    ...
    <tbody>
        <tr>
            <td class="main-table-td">
                ...
                <div class="mb-2">
                    We are sorry to announce that your refund request for <span class="font-medium text">order # 38578923</span> is cancelled because you request does not full fill meet up the <a href="" class="text-base font-medium">Refund and Return Policy</a> of our system
                </div>
                <hr>
                <div class="mb-2">
