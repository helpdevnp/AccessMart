    ...
    <tbody>
        <tr>
            <td class="main-table-td">
                ...
                <img src="{{asset('/public/assets/admin/img/cash-collected.png')}}" alt="">
                    <h2>Balance Added in Wallet!</h2>
                    <div class="mb-2"><strong>Transaction ID - 23984357sd834</strong></div>
                    <div class="mb-2">Admin has collected cash from your wallet balance</div>
                    <div class="mb-4"><span class="text-base">Note from admin :</span>Please review this transaction details. </div>
                </div>
                ...
                <span class="d-block text-center" style="margin-top: 16px">
                    <a href="" class="cmn-btn">View Transaction</a>
                </span>
                <hr>
                <div class="mb-2">
