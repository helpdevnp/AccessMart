    ...
    <tbody>
        <tr>
            <td class="main-table-td">
                <h2 class="mb-3">Order has been placed successfully !</h2>
                <div class="mb-1">Hi Sabrina,</div>
                <div class="mb-4">Your order from <a href="" class="text-base font-medium">Morning Mart</a> has been placed. To know the current status of your order click track order.</div>
