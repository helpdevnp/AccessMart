    ...
    <table style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
        <tr>
            <td style="padding:30px 30px 0">
                <img src="{{asset('/public/assets/admin/img/reg-complete.png')}}" alt="">
                <h3 style="font-size:17px;font-weight:500">Complete Registration!</h3>
        ...
        <tr>
            <td style="padding:0 30px 30px; text-align:left">
                ...
                <span style="display:block;margin-bottom:14px">
                    Thanks for choosing us. Use the following OTP to verify your account.
                </span>
