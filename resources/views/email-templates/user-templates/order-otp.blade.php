    ...
    <table style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
        <tr>
            <td style="padding:30px 30px 0">
                <img src="{{asset('/public/assets/admin/img/order-otp.png')}}" alt="">
                <h3 style="font-size:17px;font-weight:500">Order Verification!</h3>
        ...
        <tr>
            <td style="padding:0 30px 30px; text-align:left">
                ...
                <span style="display:block;">
                    To verify your order please use this One Time OTP code to confirm delivery of your order.
                </span>
                <h2 style="font-size: 26px;margin: 0;letter-spacing:4px;text-align:center">
                    349857
                </h2>
                <br>
