        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                {{-- <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/users/customer/settings') ? 'active' : '' }}">
                    <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.users.customer.settings') }}" title="{{ translate('messages.Customer') }} {{ translate('messages.settings') }}">
                ...
                <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                        {{ translate('messages.Customer') }} {{ translate('Chat') }}
                    </span>
                </a>
            </li> --}}
                @endif
