                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn--container justify-content-center">
                                                ...
                                                onclick="form_alert('criteria-{{$criteria['id']}}','{{ translate('Want to delete this criteria ?') }}')" title="{{translate('messages.delete')}} {{translate('messages.criteria')}}"><i class="tio-delete-outlined"></i>
                                                </a>
