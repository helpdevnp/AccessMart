        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.business-settings.module.update',[$module['id']])}}" method="post" enctype="multipart/form-data">
                    ...
                    @if($language)
                        ...
                        <div class="lang_form" id="default-form">
                            <div class="form-group" >
                                <label class="input-label" for="exampleFormControlInput1">{{ translate('messages.Business_Module') }} {{translate('messages.name')}} ({{ translate('messages.default') }})</label>
                                <input type="text" name="module_name[]" class="form-control" maxlength="191" value="{{$module?->getRawOriginal('module_name')}}" required oninvalid="document.getElementById('en-link').click()">
                            </div>
                            <div class="form-group">
                        ...
                        @foreach(json_decode($language) as $lang)
                            ...
                            <div class="d-none lang_form" id="{{$lang}}-form">
                                <div class="form-group" >
                                    <label class="input-label" for="exampleFormControlInput1">{{ translate('messages.Business_Module') }} {{translate('messages.name')}} ({{strtoupper($lang)}})</label>
                    ...
                    @else
                        <div class="form-group">
                            <label class="input-label" for="exampleFormControlInput1">{{ translate('messages.Business_Module') }} {{translate('messages.name')}}</label>
                    ...
                    <div class="form-group" id="module_theme" >
                        <label class="input-label" for="module_type">{{translate('messages.choose_theme')}}</label>
                        <div class="row">
