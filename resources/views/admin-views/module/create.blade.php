            ...
            <form action="{{route('admin.business-settings.module.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="lang_form p-1 mb-2" id="default-form">
                    <div class="form-group">
                        <label class="input-label text-capitalize d-flex" for="exampleFormControlInput1">{{translate('Business_Module')}} {{translate('messages.name')}} ({{ translate('messages.default') }})</label>
                        <input type="text" name="module_name[]" class="form-control" maxlength="191" required oninvalid="document.getElementById('en-link').click()" placeholder="{{ translate('messages.Ex:_Grocery,eCommerce,Pharmacy,etc.') }}">
                    </div>
                    <div class="form-group">
                ...
                <div class="d-none lang_form p-1 mb-2" id="{{$lang}}-form">
                    <div class="form-group">
                        <label class="input-label text-capitalize d-flex" for="exampleFormControlInput1">{{translate('Business_Module')}} {{translate('messages.name')}} ({{strtoupper($lang)}})</label>
                ...
                @else
                <div class="form-group">
                    <label class="input-label" for="exampleFormControlInput1">{{translate('Business_Module')}} {{translate('messages.name')}}</label>
                    <input type="text" name="module_name" class="form-control" placeholder="{{translate('messages.new_category')}}" value="{{old('name')}}" required maxlength="191"  placeholder="{{ translate('messages.Ex:') }} {{ translate('messages.business_Module Name') }}">
                </div>
                <div class="form-group">
                    <label class="input-label" for="module_type">{{ translate('Business_Module') }} {{translate('messages.description')}}</label>
                    <textarea class="ckeditor form-control" name="description"></textarea>
                </div>
                <input type="hidden" name="lang[]" value="default">
                @endif
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="module_type" id="module_type" class="form-control text-capitalize" onchange="modulChange(this.value)">
                                <option disabled selected>{{translate('messages.select')}} {{translate('messages.business_module_type')}}</option>
                ...
                <div class="form-group" id="module_theme">
                    <label class="input-label" for="module_type">{{translate('messages.Choose_a_Theme_for_the_module')}}</label>
                    <div class="row g-4">
